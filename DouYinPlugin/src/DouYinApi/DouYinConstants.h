...
inline const std::string TtWidUrl = "https://ttwid.bytedance.com/ttwid/union/register/";
constexpr const char kTtWidData[] = R"delimiter(
{"region":"cn","aid":1768,"needFid":false,"service":"www.ixigua.com","migrate_info":{"ticket":"","source":"node"},"cbUrlProtocol":"https","union":true}
)delimiter";
inline const std::string MsTokenUrl = "https://mssdk.bytedance.com/web/common";
constexpr const char kMsTokenData[] = R"delimiter(
{
    "magic": 538969122,
    "version": 1,
    "dataType": 8,
...
inline const char kMsToken[] =
    "9cguMjz4GIfQV50B_D49quM-cEyIvWMwWi0gj1bf-4YprIjt29ZrAxmDb5oIhmzEhwvcmcC4BR_kEZGmXdS1q7Ad3V94izdpXwtxgPPpozVUzQVm7KDrc5H9nfN3pLw=";

inline const std::string WebIdUrl = "https://mcs.zijieapi.com/webid";
inline constexpr char webIdParam[] = "aid=6383&sdk_version=5.1.24_dy&device_platform=web";
inline constexpr char webIdData[] = R"delimiter(
{"app_id":6383,"url":"https://www.douyin.com/", "referer":"https://www.douyin.com/", "user_unique_id":"",
"user_agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36"
}
)delimiter";

inline const std::string apiBase = "https://edith.douyin.com";
inline const std::string home = "https://www.douyin.com";
inline const std::string login = "https://login.douyin.com";

constexpr char domain[] = ".douyin.com";

namespace Login
{
inline const std::string QRCreate = "/passport/web/get_qrcode/";
inline const std::string QRCheck = "/passport/web/check_qrconnect/";
inline const std::string AccountInfo = "/passport/web/user/info/";

}  // namespace Login

namespace Api
{
inline const std::string Detail = "/aweme/v1/web/aweme/detail/";
inline const std::string Series = "/aweme/v1/web/series/aweme/";
inline const std::string Mix = "/aweme/v1/web/mix/aweme/";
inline const std::string UserAll = "/aweme/v1/web/aweme/post/";

inline const std::string UserShortInfo = "/aweme/v1/web/im/user/info/";

inline const std::string Relation = "/aweme/v1/web/im/spotlight/relation/";
inline const std::string Favorite = "/aweme/v1/web/aweme/favorite/";
inline const std::string ListCollection = "/aweme/v1/web/aweme/listcollection/";
inline const std::string UserInfo = "/aweme/v1/web/user/profile/other/";
inline const std::string UserHistory = "/aweme/v1/web/history/read/";
inline const std::string UserMixList = "/aweme/v1/web/mix/list/";
}  // namespace Api
