...
namespace download
{
WeiboDownloader::WeiboDownloader()
    : m_finished(false)
    , m_haveTwoPart(false)
{
...
WeiboDownloader::WeiboDownloader(std::list<std::string> videoUris, std::list<std::string> audioUris, std::string path, std::string filename)
    : m_finished(false)
    , m_haveTwoPart(false)
...
WeiboDownloader::WeiboDownloader(ResourceInfo info)
...
void WeiboDownloader::downloadStatus()
{
...
void WeiboDownloader::finish()
{
    m_finished = true;
}

void WeiboDownloader::setVideoUris(const std::list<std::string>& videoUris)
{
    m_videoDownloader.setUris(videoUris);
}

void WeiboDownloader::setAudioUris(const std::list<std::string>& audioUri)
{
    m_audioDownloader.setUris(audioUri);
    m_haveTwoPart = !audioUri.empty();
}

void WeiboDownloader::setPath(std::string path)
{
    m_path = std::move(path);
...
const std::string& WeiboDownloader::path() const
{
    return m_path;
}

void WeiboDownloader::setFilename(std::string filename)
{
    m_filename = std::move(filename);
    setAriaFileName();
}

const std::string& WeiboDownloader::filename() const
{
    return m_filename;
}

const std::list<std::string>& WeiboDownloader::uris() const
{
    return m_uris;
}

bool WeiboDownloader::isFinished() const
{
    return m_finished;
}

std::string WeiboDownloader::nowDownload() const
{
    return std::string();
}
